        ...
        <div class="dashboard-card mt-5">
            ...
            <ul class="list-group mb-3">
                <?php foreach($rekomendasi['artikel'] as $a): ?>
                    <li class="list-group-item">• <?php echo htmlspecialchars($a['title']); ?></li>
                <?php endforeach; ?>
            </ul>
            <div class="section-title">Rekomendasi Webinar</div>
            <ul class="list-group mb-3">
                <?php foreach($rekomendasi['webinar'] as $w): ?>
                    <li class="list-group-item">• <?php echo htmlspecialchars($w['title']); ?></li>
                <?php endforeach; ?>
            </ul>
            <div class="section-title">Rekomendasi Challenge</div>
            <ul class="list-group">
                <?php foreach($rekomendasi['challenge'] as $c): ?>
                    <li class="list-group-item">• <?php echo htmlspecialchars($c['title']); ?></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
